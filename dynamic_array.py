...
def concat(dynamic_array1: 'DynamicArray', dynamic_array2: 'DynamicArray') -> 'DynamicArray':
    ...
    new_dynamic = DynamicArray(.length() + dynamic_array2.length())
...
def copy_self(self) -> 'DynamicArray':
    """
    Make a copy of self
    :return:
    """
...
class DynamicArray(object):
    ...
    def __eq__(self, other: 'DynamicArray') -> bool:
        ...
        """
        if self.__size != length(other) or self.__capacity != other.__capacity:
            return False
